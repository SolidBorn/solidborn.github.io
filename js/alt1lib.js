...
a1lib.findsubimg=function(bigimg,checkbuf,checklist,sx,sy,sw,sh){
	...
	if (!bigimg) { console.log("Warning - no large image provided in a1lib.findsubimg."); return false;}
	if (!checkbuf) { console.log("Warning - no small searchimg provided in a1lib.findsubimg."); return false; }
